<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WeeklyStaffReq.aspx.cs" Inherits="GDLCApp.Operations.Weekly.WeeklyStaffReq" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                             ...
                             <telerik:RadGrid ID="weeklyStaffReqGrid" runat="server" DataSourceID="weeklyStaffReqSource" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowPaging="False" AllowSorting="True" CellSpacing="-1" GridLines="Both" OnItemCommand="weeklyStaffReqGrid_ItemCommand" OnDeleteCommand="weeklyStaffReqGrid_DeleteCommand">
                            <ClientSettings>
                        ...
                        <asp:SqlDataSource ID="weeklyStaffReqSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TOP (30) AutoNo, ReqNo, date_, Approved, DLEcodeCompanyName, WorkerName FROM vwWeeklyReq WHERE (ReqNo LIKE '%' + @ReqNo + '%') ORDER BY AutoNo DESC">
                            <SelectParameters>
