<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditAllocation.aspx.cs" Inherits="GDLCApp.Operations.Allocation.EditAllocation" %>
                ...
                items
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/Operations/Allocation/Allocation.aspx" style="margin-bottom:0px"/>
                            <asp:Button runat="server" ID="btnFind" Text="Find" CssClass="btn btn-success" OnClientClick="newRequestModal()" CausesValidation="false" />
                            <asp:Button runat="server" ID="btnPrint" Text="Print" CssClass="btn btn-info" OnClick="btnPrint_Click"  />
                            <asp:Button runat="server" ID="btnUpdate" Text="Save Changes" CssClass="btn btn-primary" OnClick="btnUpdate_Click"  />
                        </div>   
                    </ContentTemplate>
                             <Triggers>
