<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditDailyReq.aspx.cs" Inherits="GDLCApp.Operations.Daily.EditDailyReq" %>
                ...
                items
                            ...
                            <div class="col-md-5">
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-8">
                                        <telerik:RadDatePicker DateInput-Font-Bold="true" runat="server" ID="dpRegdate" Width="100%" DateInput-ReadOnly="true"></telerik:RadDatePicker>
            ...
            <FooterTemplate>
                ...
                items
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                    <div class="col-sm-12">
                                        <asp:CheckBox ID="chkShipSide" runat="server" Text="Ship Side" TextAlign="Left" /> <br />
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/Operations/Daily/DailyStaffReq.aspx" style="margin-bottom:0px" />
