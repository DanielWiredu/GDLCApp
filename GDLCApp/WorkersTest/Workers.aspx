<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Workers.aspx.cs" Inherits="GDLCApp.WorkersTest.Workers" %>
   ...
   <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                                        ...
                                        <div class="col-sm-8 pull-left">
                                            <div class="toolbar-btn-action">
                                                <asp:Button runat="server" ID="btnAddNew" CssClass="btn btn-success" Text="Add Worker" CausesValidation="false" PostBackUrl="~/WorkersTest/NewWorker.aspx" />  
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <asp:SqlDataSource ID="workerSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [WorkerID], [SName], [OName], [Date_Birth], [GangName], [SSFNo], [TradegroupNAME], [TradetypeNAME], [NHIS], [ezwichid] FROM [vwWorkersTest]" DeleteCommand="spDeleteWorker" DeleteCommandType="StoredProcedure">
                            <%--<DeleteParameters>
