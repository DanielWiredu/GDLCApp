<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewWorker.aspx.cs" Inherits="GDLCApp.WorkersTest.NewWorker" %>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <asp:RequiredFieldValidator Enabled="false" runat="server" ControlToValidate="txtSSFNo" Display="Dynamic" ErrorMessage="Required Field" SetFocusOnError="true" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                    <div class="form-group">
