...
{
    public partial class vwLoanRepayments_Monthly : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptLoanRepaymentMonthly";
            ...
            {
                LoanRepaymentReport_Monthly.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwLoanRepayments where (ApprovedDate between @startdate and @enddate) and Approved = 1 and ReqNo like 'M%'", connection);
            ...
            LoanRepaymentReport_Monthly.ReportSource = rpt;
        }
    }
}