...
{
    public partial class vwLoanRepayments_Receipt : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptLoanRepaymentReceipt";
            ...
            {
                LoanRepaymentReport_Receipt.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwLoanRepayments where (ApprovedDate between @startdate and @enddate) and Approved = 1 and ReqNo like 'R%'", connection);
            ...
            LoanRepaymentReport_Receipt.ReportSource = rpt;
        }
    }
}