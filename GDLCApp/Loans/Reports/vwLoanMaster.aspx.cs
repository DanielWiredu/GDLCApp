...
{
    public partial class vwLoanMaster : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptLoanMaster";
            ...
            {
                LoanMasterReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptLoanMaster rpt = new rptLoanMaster();
            ...
            adapter = new SqlDataAdapter("select * from vwLoans where (CreatedDate between @startdate and @enddate)", connection);
            ...
            LoanMasterReport.ReportSource = rpt;
        }
    }
}