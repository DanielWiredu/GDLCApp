...
{
    public partial class vwLoanRepaymentAll : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptLoanRepaymentAll";
            ...
            {
                LoanRepaymentReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwLoanRepayments where (ApprovedDate between @startdate and @enddate) and Approved = 1", connection);
