...
{
    public partial class vwLoanRepayments_Daily : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptLoanRepaymentDaily";
            ...
            {
                LoanRepaymentReport_Daily.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwLoanRepayments where (ApprovedDate between @startdate and @enddate) and Approved = 1 and ReqNo like 'D%'", connection);
            ...
            LoanRepaymentReport_Daily.ReportSource = rpt;
        }
    }
}