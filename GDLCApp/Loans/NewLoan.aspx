<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewLoan.aspx.cs" Inherits="GDLCApp.Loans.NewLoan" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                    <div class="col-sm-12">
                                        <asp:CheckBox ID="chkAutoDeduct" runat="server" Checked="true" Text="Auto Deduct" ForeColor="Green" TextAlign="Left" />
                                    </div>
                                </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/Loans/LoanManager.aspx" />
            ...
            <ContentTemplate>
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Workers</h4>
                        ...
                        <asp:SqlDataSource ID="workerSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [WorkerID], [WorkerType], [SName], [OName], [GangName], [SSFNo], [TradegroupID], [TradegroupNAME] ,[TradetypeID], [TradetypeNAME], [NHIS], [flags], [ezwichid] FROM [vwWorkers]">
                        </asp:SqlDataSource>
                            </div>
                       </div>
