<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="LoanRepayments.aspx.cs" Inherits="GDLCApp.Loans.LoanRepayments" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        ...
                        <hr />
                             <telerik:RadGrid ID="loanGrid" runat="server" DataSourceID="loanSource" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowPaging="False" AllowSorting="True" CellSpacing="-1" GridLines="Both" OnItemCommand="loanGrid_ItemCommand">
                            <ClientSettings>
