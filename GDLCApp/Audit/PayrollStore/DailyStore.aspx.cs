...
{
    public partial class DailyStore : System.Web.UI.Page
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("spStoreDailyReq", connection))
                {
        ...
        protected void btnDeleteStored_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand("spDeleteStoredDailyReq", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
