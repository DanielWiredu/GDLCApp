...
{
    public partial class WeeklyStore : System.Web.UI.Page
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("spStoreWeeklyReq", connection))
                {
        ...
        protected void btnDeleteStored_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand("spDeleteStoredWeeklyReq", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
