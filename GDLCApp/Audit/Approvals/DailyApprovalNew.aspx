<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="DailyApprovalNew.aspx.cs" Inherits="GDLCApp.Audit.Approvals.DailyApprovalNew" %>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5> Daily Requisition Approval</h5>
            ...
            <FooterTemplate>
                ...
                items
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox CssClass="txtnumber" ID="txtNormalHrs" runat="server" Width="100%" TextMode="Number" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                                    <div class="form-group">
                                    <label class="col-sm-7 control-label">Overtime Hrs</label>
                                    <div class="col-sm-5">
                                        <asp:TextBox CssClass="txtnumber" ID="txtOvertimeHrs" runat="server" Width="100%" TextMode="Number" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                                </div>
                            </div>
        ...
        <asp:Panel runat="server" DefaultButton="btnSearch">
            ...
            <script type="text/javascript">
                ...
                $('#newmodal').on('shown.bs.modal', function () {                    
                    ...
                    //var input = document.getElementById('txtarea').focus();
                    //var tb = $get("txtSearchValue");
                    //tb.focus();
                });
                //(function ($) {
                //    // jQuery code using $
