<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WeeklySubmissions.aspx.cs" Inherits="GDLCApp.ClientPortal.WeeklySubmissions" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                             ...
                             <telerik:RadGrid ID="weeklyStaffReqGrid" runat="server" DataSourceID="weeklyStaffReqSource" AllowFilteringByColumn="true" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowPaging="True" AllowSorting="True" CellSpacing="-1" GridLines="Both">
                            <ClientSettings>
                                <Scrolling AllowScroll="True" UseStaticHeaders="True" ScrollHeight="400px" />
                                <Selecting AllowRowSelect="true" />
                            </ClientSettings>
                            <GroupingSettings CaseSensitive="false" />
                                 <ExportSettings IgnorePaging="true" ExportOnlyData="true" OpenInNewWindow="true" FileName="weeklycostsheets" HideStructureColumns="true"  >
                                    </ExportSettings>
                                 <MasterTableView DataKeyNames="ReqNo" DataSourceID="weeklyStaffReqSource" AllowFilteringByColumn="true" PageSize="100">
                                     <Columns>
