<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditLabourAdvice.aspx.cs" Inherits="GDLCApp.ClientPortal.EditLabourAdvice" %>
                ...
                items
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/ClientPortal/LabourAdvice.aspx" style="margin-bottom:0px" />
