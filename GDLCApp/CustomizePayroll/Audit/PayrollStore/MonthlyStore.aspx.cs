...
namespace GDLCApp.CustomizePayroll.Audit.PayrollStore
{
    public partial class MonthlyStore : System.Web.UI.Page
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("spStoreMonthlyReq_CS", connection))
                {
        ...
        protected void btnDeleteStored_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand("spDeleteStoredMonthlyReq_CS", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
