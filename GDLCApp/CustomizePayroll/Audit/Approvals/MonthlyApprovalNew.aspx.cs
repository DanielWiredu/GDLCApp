...
namespace GDLCApp.CustomizePayroll.Audit.Approvals
{
    public partial class MonthlyApprovalNew : System.Web.UI.Page
    {
        ...
        protected void loadReqNo()
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("spGetMonthlyReqNoDetails_CS", connection))
                {
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand("spApproveMonthlyReq_CS", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
                    ...
                    try
                    {
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "", "toastr.error('Cannot Approve. No Payroll Setup for Company', 'Error');", true);
                        }
                    }
        ...
        protected void btnDisapprove_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand("spDisapproveMonthlyReq_CS", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
