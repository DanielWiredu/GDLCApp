...
namespace GDLCApp.CustomizePayroll.Audit.PayrollProcess
{
    public partial class MonthlyPayroll : System.Web.UI.Page
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("spProcessMonthlyReq_CS", connection))
                {
