...
namespace GDLCApp.CustomizePayroll.Reports.Monthly.General
{
    public partial class vwMonthlyPreviewCostSheet : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyPreviewCostSheet_CS";
            ...
            {
                MonthlyPreviewCostSheetReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReportNew(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyPreviewCostSheet_CS where (date_ between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyPreviewCostSheet_CS");
