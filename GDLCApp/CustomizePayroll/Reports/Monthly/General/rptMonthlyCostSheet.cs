...
namespace GDLCApp.CustomizePayroll.Reports.Monthly.General {
    ...
    public class rptMonthlyCostSheet : ReportClass {
        
        public rptMonthlyCostSheet() {
        }
        
        public override string ResourceName {
            get {
                return "rptMonthlyCostSheet.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "GDLCApp.CustomizePayroll.Reports.Monthly.General.rptMonthlyCostSheet.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMonthlyCostSheet : Component, ICachedReport {
        
        public CachedrptMonthlyCostSheet() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptMonthlyCostSheet rpt = new rptMonthlyCostSheet();
            rpt.Site = this.Site;
            return rpt;
        }
