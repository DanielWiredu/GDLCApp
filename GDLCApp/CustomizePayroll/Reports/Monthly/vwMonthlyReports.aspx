<%@ Page Title="" Language="C#" MasterPageFile="~/CustomizePayroll/CSHome.Master" AutoEventWireup="true" CodeBehind="vwMonthlyReports.aspx.cs" Inherits="GDLCApp.CustomizePayroll.Reports.Monthly.vwMonthlyReports" %>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <telerik:RadDropDownList runat="server" ID="dlReportType" Width="100%" DefaultMessage="Select Report Type">
                                        <Items >
                                            ...
                                            <telerik:DropDownListItem Text="Monthly Processed Summary" />
