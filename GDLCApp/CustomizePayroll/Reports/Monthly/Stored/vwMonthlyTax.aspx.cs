...
{
    public partial class vwMonthlyTax : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyTax_CS";
            ...
            {
                MonthlyTaxReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptMonthlyTax rpt = new rptMonthlyTax();
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyTax_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyTax_CS");
            ...
            MonthlyTaxReport.ReportSource = rpt;
        }
    }
}