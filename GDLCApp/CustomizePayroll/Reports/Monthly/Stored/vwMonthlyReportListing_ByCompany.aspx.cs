...
namespace GDLCApp.CustomizePayroll.Reports.Monthly.Stored
{
    public partial class vwMonthlyReportListing_ByCompany : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyReportListing_Stored_ByCompany_CS";
            ...
            {
                MonthlyReportListingReport_ByCompany.ReportSource = Cache[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("spGetMonthlyReportListingByCompany_Stored_CS", connection);
            ...
            adapter.Fill(ds, "vwMonthlyReportListing_Stored_CS");
