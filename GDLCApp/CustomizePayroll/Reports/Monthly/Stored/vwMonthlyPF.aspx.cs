...
{
    public partial class vwMonthlyPF : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyPF_CS";
            ...
            {
                MonthlyPFReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptMonthlyPF rpt = new rptMonthlyPF();
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyPF_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyPF_CS");
            ...
            MonthlyPFReport.ReportSource = rpt;
        }
    }
}