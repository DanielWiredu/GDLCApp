...
{
    public partial class vwMonthlyStatistics : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyStatistics_Stored_CS";
            ...
            {
                MonthlyStatisticsReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        {
            rptMonthlyStatistics rpt = new rptMonthlyStatistics();
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyStatistics_Stored_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyStatistics_Stored_CS");
            ...
            MonthlyStatisticsReport.ReportSource = rpt;
        }
    }
}