...
namespace GDLCApp.CustomizePayroll.Reports.Monthly.Stored
{
    public partial class vwMonthlySSF : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlySSF_CS";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlySSF_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlySSF_CS");
