...
{
    public partial class vwMonthlyLeaveBonus : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyLeaveBonus_CS";
            ...
            {
                MonthlyLeaveBonusReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptMonthlyLeaveBonus rpt = new rptMonthlyLeaveBonus();
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyLeaveBonus_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyLeaveBonus_CS");
            ...
            MonthlyLeaveBonusReport.ReportSource = rpt;
        }
    }
}