...
namespace GDLCApp.CustomizePayroll.Reports.Monthly.Stored
{
    public partial class vwMonthlyInvoice : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyInvoice_Stored_CS";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyInvoice_Stored_CS where (Adate between @startdate and @enddate)", connection);
