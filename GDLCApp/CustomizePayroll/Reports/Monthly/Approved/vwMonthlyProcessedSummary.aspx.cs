...
{
    public partial class vwMonthlyProcessedSummary : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyProcessedSummary_CS";
            ...
            {
                MonthlyProcessedSummaryReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptMonthlyProcessedSummary rpt = new rptMonthlyProcessedSummary();
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyProcessed_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyProcessed_CS");
            ...
            MonthlyProcessedSummaryReport.ReportSource = rpt;
        }
    }
}