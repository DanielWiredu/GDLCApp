...
{
    public partial class vwMonthlyProcessedSummary_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyProcessedSummary_ByCompany_CS";
            ...
            {
                MonthlyProcessedSummaryReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetMonthlyProcessedByCompany_CS", connection);
            ...
            MonthlyProcessedSummaryReport_ByCompany.ReportSource = rpt;
        }
    }
}