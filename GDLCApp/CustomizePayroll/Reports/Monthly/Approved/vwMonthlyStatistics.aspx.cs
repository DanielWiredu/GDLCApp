...
namespace GDLCApp.CustomizePayroll.Reports.Monthly.Approved
{
    public partial class vwMonthlyStatistics : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyStatistics_CS";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyStatistics_CS where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyStatistics_CS");
