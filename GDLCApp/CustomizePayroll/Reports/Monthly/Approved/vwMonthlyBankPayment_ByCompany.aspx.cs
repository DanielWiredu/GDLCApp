...
{
    public partial class vwMonthlyBankPayment_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyBankPayment_ByCompany_CS";
            ...
            {
                MonthlyBankPaymentReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetMonthlyBankPaymentByCompany_CS", connection);
            ...
            MonthlyBankPaymentReport_ByCompany.ReportSource = rpt;
        }
    }
}