...
{
    public partial class vwMonthlyApprovedCostSheet : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyApprovedCostSheet_CS";
        ...
        protected void loadReportNew(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyApprovedCostSheet_CS where (Adate between @startdate and @enddate)", connection);
