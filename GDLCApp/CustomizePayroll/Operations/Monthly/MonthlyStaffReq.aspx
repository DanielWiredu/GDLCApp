<%@ Page Title="" Language="C#" MasterPageFile="~/CustomizePayroll/CSHome.Master" AutoEventWireup="true" CodeBehind="MonthlyStaffReq.aspx.cs" Inherits="GDLCApp.CustomizePayroll.Operations.Monthly.MonthlyStaffReq" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                                        ...
                                        <div class="col-sm-8 pull-left">
                                            <div class="toolbar-btn-action">
                                                <asp:Button runat="server" ID="btnAddNew" CssClass="btn btn-success" Text="Add" CausesValidation="false" PostBackUrl="~/CustomizePayroll/Operations/Monthly/NewMonthlyReq.aspx" />  
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <asp:SqlDataSource ID="monthlyStaffReqSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TOP (30) AutoNo, ReqNo, date_, Approved, DLEcodeCompanyName, WorkerName FROM vwMonthlyReq_CS WHERE (ReqNo LIKE '%' + @ReqNo + '%') ORDER BY AutoNo DESC">
                            <SelectParameters>
