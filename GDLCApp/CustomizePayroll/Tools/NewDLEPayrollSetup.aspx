<%@ Page Title="" Language="C#" MasterPageFile="~/CustomizePayroll/CSHome.Master" AutoEventWireup="true" CodeBehind="NewDLEPayrollSetup.aspx.cs" Inherits="GDLCApp.CustomizePayroll.Tools.NewDLEPayrollSetup" %>
                ...
                items
                      ...
                      <%--  <hr />--%>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnAddNew" Text="Add New" CssClass="btn btn-danger" CausesValidation="false" OnClick="btnAddNew_Click" />
