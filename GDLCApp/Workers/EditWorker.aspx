<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditWorker.aspx.cs" Inherits="GDLCApp.Workers.EditWorker" %>
                ...
                items
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-8">
                                        <telerik:RadDropDownList ID="dlBank" runat="server" Width="100%" DefaultMessage="Select Bank" DataSourceID="bankSource" DataTextField="BankName" DataValueField="BankId" DropDownHeight="200px" AutoPostBack="true" CausesValidation="false" OnSelectedIndexChanged="dlBank_SelectedIndexChanged"></telerik:RadDropDownList>
