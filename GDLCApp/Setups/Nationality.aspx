<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Nationality.aspx.cs" Inherits="GDLCApp.Setups.Nationality" %>
                    ...
                    <ContentTemplate>
                        <div class="row">
                            ...
                            <GroupingSettings CaseSensitive="false" />
                                 <ExportSettings IgnorePaging="true" ExportOnlyData="true" OpenInNewWindow="true" FileName="nationality_list" HideStructureColumns="true"  >
                                        <Pdf AllowPrinting="true" AllowCopy="true" PaperSize="Letter" PageTitle="Nationality List" PageWidth="500"></Pdf>
                                    </ExportSettings>
                            <MasterTableView DataKeyNames="ID" DataSourceID="nationalitySource" AllowAutomaticDeletes="true">
                                <Columns>
                        ...
                        <asp:SqlDataSource ID="nationalitySource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tblNationality] ORDER BY [ID]" DeleteCommand="DELETE FROM [tblNationality] WHERE [ID] = @ID">
                            <DeleteParameters>
