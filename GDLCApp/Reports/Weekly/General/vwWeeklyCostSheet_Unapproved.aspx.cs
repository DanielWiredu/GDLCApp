...
{
    public partial class vwWeeklyCostSheet_Unapproved : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyCostSheet_Unapproved";
            ...
            {
                WeeklyCostSheetReport_Unapproved.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyCostSheet where Approved = 0 and (date_ between @startdate and @enddate)", connection);
            ...
            WeeklyCostSheetReport_Unapproved.ReportSource = rpt;
        }
    }
}