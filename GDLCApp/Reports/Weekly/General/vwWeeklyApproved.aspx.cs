...
{
    public partial class vwWeeklyApproved : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyApproved";
            ...
            {
                WeeklyApprovedReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyApproved rpt = new rptWeeklyApproved();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyApproved where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyApproved");
            ...
            WeeklyApprovedReport.ReportSource = rpt;
        }
    }
}