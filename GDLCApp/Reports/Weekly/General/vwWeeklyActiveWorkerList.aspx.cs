...
{
    public partial class vwWeeklyActiveWorkerList : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyActiveWorkers";
            ...
            {
                WeeklyActiveWorkersReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyActiveWorkers rpt = new rptWeeklyActiveWorkers();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyActiveWorkers where (date_ between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyActiveWorkers");
            ...
            WeeklyActiveWorkersReport.ReportSource = rpt;
        }
    }
}