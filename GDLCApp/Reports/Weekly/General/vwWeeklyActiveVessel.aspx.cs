...
{
    public partial class vwWeeklyActiveVessel : System.Web.UI.Page
    {
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyActiveVessel where (TransDate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyActiveVessel");
