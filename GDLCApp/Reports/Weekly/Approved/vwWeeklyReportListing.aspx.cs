...
namespace GDLCApp.Reports.Weekly.Approved
{
    public partial class vwWeeklyReportListing : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptWeeklyReportListing";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyReportListing where (Adate between @startdate and @enddate)", connection);
