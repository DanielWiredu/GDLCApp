...
{
    public partial class vwWeeklyApprovedCostSheet : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyApprovedCostSheet";
            ...
            {
                WeeklyApprovedCostSheetReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyApprovedCostSheet rpt = new rptWeeklyApprovedCostSheet();
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwWeeklyApprovedCostSheet where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyApprovedCostSheet");
            ...
            WeeklyApprovedCostSheetReport.ReportSource = rpt;
        }
    }
}