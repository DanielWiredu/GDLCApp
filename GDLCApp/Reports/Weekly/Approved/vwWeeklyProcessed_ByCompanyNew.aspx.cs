...
{
    public partial class vwWeeklyProcessed_ByCompanyNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyProcessed_ByCompanyNew";
            ...
            {
                WeeklyProcessedReport_ByCompanyNew.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            WeeklyProcessedReport_ByCompanyNew.ReportSource = rpt;
        }
    }
}