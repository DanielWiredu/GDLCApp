...
{
    public partial class vwWeeklyProcessedNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyProcessedNew";
            ...
            {
                WeeklyProcessedNewReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            WeeklyProcessedNewReport.ReportSource = rpt;
        }
    }
}