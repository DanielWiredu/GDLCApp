...
{
    public partial class vwWeeklyStatistics_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyStatistics_ByCompany";
            ...
            {
                WeeklyStatisticsReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            WeeklyStatisticsReport_ByCompany.ReportSource = rpt;
        }
    }
}