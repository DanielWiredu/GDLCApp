...
{
    public partial class vwWeeklyReportListing_Disapproved : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyReportListing_Disapproved";
            ...
            {
                WeeklyReportListingDisapprovedReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyReportListing_Disapproved rpt = new rptWeeklyReportListing_Disapproved();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyReportListing_Disapproved where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyReportListing_Disapproved");
            ...
            WeeklyReportListingDisapprovedReport.ReportSource = rpt;
        }
    }
}