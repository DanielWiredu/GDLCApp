...
{
    public partial class vwWeeklyLeaveBonus : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyLeaveBonus";
            ...
            {
                WeeklyLeaveBonusReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyLeaveBonus rpt = new rptWeeklyLeaveBonus();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyLeaveBonus where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyLeaveBonus");
            ...
            WeeklyLeaveBonusReport.ReportSource = rpt;
        }
    }
}