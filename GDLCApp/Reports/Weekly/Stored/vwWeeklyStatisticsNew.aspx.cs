...
{
    public partial class vwWeeklyStatisticsNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyStatistics_StoredNew";
            ...
            {
                WeeklyStatisticsNewReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyStatisticsNew rpt = new rptWeeklyStatisticsNew();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyStatistics_Stored where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyStatistics_Stored");
            ...
            WeeklyStatisticsNewReport.ReportSource = rpt;
        }
    }
}