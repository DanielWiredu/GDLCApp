...
{
    public partial class vwWeeklyReportListing : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyReportListing_Stored";
            ...
            {
                WeeklyReportListingReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyReportListing_Stored where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyReportListing_Stored");
            ...
            WeeklyReportListingReport.ReportSource = rpt;
        }
    }
}