...
{
    public partial class vwWeeklyTax : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyTax";
            ...
            {
                WeeklyTaxReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyTax rpt = new rptWeeklyTax();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyTax where (Adate between @startdate and @enddate)", connection);
            ...
            WeeklyTaxReport.ReportSource = rpt;
        }
    }
}