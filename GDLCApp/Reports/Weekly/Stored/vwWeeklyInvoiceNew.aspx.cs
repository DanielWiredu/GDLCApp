...
{
    public partial class vwWeeklyInvoiceNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyInvoice_StoredNew";
            ...
            {
                WeeklyInvoiceNewReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyInvoice_Stored where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklyInvoice_Stored");
            ...
            WeeklyInvoiceNewReport.ReportSource = rpt;
        }
    }
}