...
{
    public partial class vwWeeklySSF : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklySSF";
            ...
            {
                WeeklySSFReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklySSF rpt = new rptWeeklySSF();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklySSF where (Adate between @startdate and @enddate)", connection);
            ...
            WeeklySSFReport.ReportSource = rpt;
        }
    }
}