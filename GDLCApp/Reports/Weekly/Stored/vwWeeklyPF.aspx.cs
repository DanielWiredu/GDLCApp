...
{
    public partial class vwWeeklyPF : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyPF";
            ...
            {
                WeeklyPFReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyPF rpt = new rptWeeklyPF();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklyPF where (Adate between @startdate and @enddate)", connection);
            ...
            WeeklyPFReport.ReportSource = rpt;
        }
    }
}