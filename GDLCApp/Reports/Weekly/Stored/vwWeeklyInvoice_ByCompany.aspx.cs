...
namespace GDLCApp.Reports.Weekly.Stored
{
    public partial class vwWeeklyInvoice_ByCompany : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptWeeklyInvoice_Stored_ByCompany";
            ...
            {
                WeeklyInvoiceReport_ByCompany.ReportSource = Cache[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklyInvoice rpt = new rptWeeklyInvoice();
            ...
            WeeklyInvoiceReport_ByCompany.ReportSource = rpt;
        }
    }
}