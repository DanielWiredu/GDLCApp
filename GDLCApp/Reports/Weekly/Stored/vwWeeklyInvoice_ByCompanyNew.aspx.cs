...
{
    public partial class vwWeeklyInvoice_ByCompanyNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklyInvoice_Stored_ByCompanyNew";
            ...
            {
                WeeklyInvoiceReport_ByCompanyNew.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetWeeklyInvoiceByCompany_Stored", connection);
            ...
            WeeklyInvoiceReport_ByCompanyNew.ReportSource = rpt;
        }
    }
}