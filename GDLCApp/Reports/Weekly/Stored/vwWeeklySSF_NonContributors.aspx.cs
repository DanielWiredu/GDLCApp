...
{
    public partial class vwWeeklySSF_NonContributors : System.Web.UI.Page
    {
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklySSF_NonContributors where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklySSF_NonContributors");
