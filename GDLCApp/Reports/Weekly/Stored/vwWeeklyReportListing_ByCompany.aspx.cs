...
namespace GDLCApp.Reports.Weekly.Stored
{
    public partial class vwWeeklyReportListing_ByCompany : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptWeeklyReportListing_Stored_ByCompany";
            ...
            {
                WeeklyReportListingReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetWeeklyReportListingByCompany_Stored", connection);
