...
namespace GDLCApp.Reports.Weekly.Stored
{
    public partial class vwWeeklySSF_Contributors : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptWeeklySSF_Contributors";
            ...
            {
                WeeklySSFReport_Contributors.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptWeeklySSF_Contributors rpt = new rptWeeklySSF_Contributors();
            ...
            adapter = new SqlDataAdapter("select * from vwWeeklySSF_Contributors where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwWeeklySSF_Contributors");
            ...
            WeeklySSFReport_Contributors.ReportSource = rpt;
        }
    }
}