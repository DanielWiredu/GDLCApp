...
{
    public partial class vwWeeklyStoredDateRange : System.Web.UI.Page
    {
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select DateStored,StartDateStored,EndDateStored from tblStoredWeekly where (DateStored between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "tblStoredWeekly");
