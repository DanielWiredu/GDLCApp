...
{
    public partial class vwDailyStatistics : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyStatistics_Stored";
            ...
            {
                DailyStatisticsReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyStatistics rpt = new rptDailyStatistics();
            ...
            DailyStatisticsReport.ReportSource = rpt;
        }
    }
}