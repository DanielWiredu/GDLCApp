...
{
    public partial class vwDailyPF : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyPF";
            ...
            {
                DailyPFReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwDailyPF where (Adate between @startdate and @enddate)", connection);
            ...
            DailyPFReport.ReportSource = rpt;
        }
    }
}