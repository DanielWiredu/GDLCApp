...
{
    public partial class vwDailyTax : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyTax";
            ...
            {
                DailyTaxReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyTax rpt = new rptDailyTax();
            ...
            adapter = new SqlDataAdapter("select * from vwDailyTax where (Adate between @startdate and @enddate)", connection);
            ...
            DailyTaxReport.ReportSource = rpt;
        }
    }
}