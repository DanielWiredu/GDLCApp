...
{
    public partial class vwDailyStoredDateRange : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyStoredDateRange";
            ...
            {
                DailyStoredDateRangeReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyStoredDateRange rpt = new rptDailyStoredDateRange();
            ...
            adapter = new SqlDataAdapter("select DateStored,StartDateStored,EndDateStored from tblStoredDaily where (DateStored between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "tblStoredDaily");
            ...
            DailyStoredDateRangeReport.ReportSource = rpt;
        }
    }
}