...
{
    public partial class vwDailySSF_NonContributors : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailySSF_NonContributors";
            ...
            {
                DailySSFReport_NonContributors.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailySSF_NonContributors rpt = new rptDailySSF_NonContributors();
            ...
            adapter = new SqlDataAdapter("select * from vwDailySSF_NonContributors where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwDailySSF_NonContributors");
            ...
            DailySSFReport_NonContributors.ReportSource = rpt;
        }
    }
}