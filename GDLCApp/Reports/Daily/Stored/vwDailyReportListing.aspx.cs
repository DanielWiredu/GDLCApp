...
namespace GDLCApp.Reports.Daily.Stored
{
    public partial class vwDailyReportListing : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptDailyReportListing_Stored";
            ...
            {
                DailyReportListingReport.ReportSource = Cache[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwDailyReportListing_Stored where (Adate between @startdate and @enddate)", connection);
