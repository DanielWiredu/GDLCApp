...
{
    public partial class vwDailySSF : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailySSF";
            ...
            {
                DailySSFReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailySSF rpt = new rptDailySSF();
            ...
            adapter = new SqlDataAdapter("select * from vwDailySSF where (Adate between @startdate and @enddate)", connection);
            ...
            DailySSFReport.ReportSource = rpt;
        }
    }
}