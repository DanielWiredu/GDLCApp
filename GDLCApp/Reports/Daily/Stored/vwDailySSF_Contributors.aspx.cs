...
{
    public partial class vwDailySSF_Contributors : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailySSF_Contributors";
            ...
            {
                DailySSFReport_Contributors.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailySSF_Contributors rpt = new rptDailySSF_Contributors();
            ...
            adapter = new SqlDataAdapter("select * from vwDailySSF_Contributors where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwDailySSF_Contributors");
            ...
            DailySSFReport_Contributors.ReportSource = rpt;
        }
    }
}