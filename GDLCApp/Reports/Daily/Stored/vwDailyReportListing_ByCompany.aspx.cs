...
{
    public partial class vwDailyReportListing_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyReportListing_Stored_ByCompany";
            ...
            {
                DailyReportListingReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetDailyReportListingByCompany_Stored", connection);
            ...
            adapter.Fill(ds, "vwDailyReportListing_Stored");
            ...
            DailyReportListingReport_ByCompany.ReportSource = rpt;
        }
    }
}