...
{
    public partial class vwDailyStatistics_ByCompanyNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyStatistics_ByCompanyNew";
            ...
            {
                DailyStatisticsReport_ByCompanyNew.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetDailyStatisticsByCompany", connection);
            ...
            DailyStatisticsReport_ByCompanyNew.ReportSource = rpt;
        }
    }
}