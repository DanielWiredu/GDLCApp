...
{
    public partial class vwDailyStatistics_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyStatistics_ByCompany";
            ...
            {
                DailyStatisticsReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            DailyStatisticsReport_ByCompany.ReportSource = rpt;
        }
    }
}