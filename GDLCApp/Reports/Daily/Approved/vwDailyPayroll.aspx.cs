...
{
    public partial class vwDailyPayroll : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyPayroll";
            ...
            {
                DailyPayrollReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyPayroll rpt = new rptDailyPayroll();
            ...
            adapter = new SqlDataAdapter("select * from vwDailyPayroll where (Adate between @startdate and @enddate)", connection);
            ...
            DailyPayrollReport.ReportSource = rpt;
        }
    }
}