...
{
    public partial class vwDailyApprovedCostSheet : System.Web.UI.Page
    {
        rptDailyApprovedCostSheet rpt = new rptDailyApprovedCostSheet();
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyApprovedCostSheet";
            ...
            {
                DailyApprovedCostSheetReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwDailyApprovedCostSheet where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwDailyApprovedCostSheet");
            ...
            DailyApprovedCostSheetReport.ReportSource = rpt;
        }
    }
}