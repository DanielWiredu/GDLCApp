...
{
    public partial class vwDailyProcessedNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyProcessedNew";
            ...
            {
                DailyProcessedNewReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyProcessedNew rpt = new rptDailyProcessedNew();
            ...
            adapter = new SqlDataAdapter("select * from vwDailyProcessed where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwDailyProcessed");
            ...
            DailyProcessedNewReport.ReportSource = rpt;
        }
    }
}