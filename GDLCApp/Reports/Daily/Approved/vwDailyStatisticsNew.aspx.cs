...
namespace GDLCApp.Reports.Daily.Approved
{
    public partial class vwDailyStatisticsNew : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptDailyStatisticsNew";
            ...
            {
                DailyStatisticsNewReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwDailyStatistics where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwDailyStatistics");
