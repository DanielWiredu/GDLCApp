...
{
    public partial class vwDailyProcessed : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyProcessed";
            ...
            {
                DailyProcessedReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyProcessed rpt = new rptDailyProcessed();
            ...
            DailyProcessedReport.ReportSource = rpt;
        }
    }
}