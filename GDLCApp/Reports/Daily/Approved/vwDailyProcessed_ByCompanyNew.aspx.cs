...
{
    public partial class vwDailyProcessed_ByCompanyNew : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyProcessed_ByCompanyNew";
            ...
            {
                DailyProcessedReport_ByCompanyNew.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetDailyProcessedByCompany", connection);
            ...
            DailyProcessedReport_ByCompanyNew.ReportSource = rpt;
        }
    }
}