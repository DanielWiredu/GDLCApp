...
{
    public partial class vwDailyActiveWorkerList : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptDailyActiveWorkers";
            ...
            {
                DailyActiveWorkerListReport.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptDailyActiveWorkers rpt = new rptDailyActiveWorkers();
            ...
            adapter = new SqlDataAdapter("select * from vwDailyActiveWorkers where (date_ between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwDailyActiveWorkers");
            ...
            DailyActiveWorkerListReport.ReportSource = rpt;
        }
    }
}