<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="AgedWorkers.aspx.cs" Inherits="GDLCApp.Reports.Queries.AgedWorkers" %>
   ...
   <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        <div class="row">
                                        ...
                                        <div class="col-sm-8 pull-left">
                                            <div class="toolbar-btn-action">
                                                <telerik:RadDatePicker ID="dpFilter" runat="server"></telerik:RadDatePicker>
                                                <asp:Button runat="server" ID="btnFilter" Text="Search" CssClass="btn-success" />
                                            </div>
                                        </div>
                                    </div>
                        <hr />
                             <telerik:RadGrid ID="workersGrid" runat="server" ShowFooter="true" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" CellSpacing="-1" GridLines="Both" DataSourceID="workerSource" OnItemCommand="workersGrid_ItemCommand" OnItemDataBound="workersGrid_ItemDataBound">
                            <ClientSettings>
                            ...
                            <GroupingSettings CaseSensitive="false" />
                                 <ExportSettings IgnorePaging="true" ExportOnlyData="true" OpenInNewWindow="true" FileName="aged_workers_list" HideStructureColumns="true"  >
                                        <Pdf AllowPrinting="true" AllowCopy="true" PaperSize="Letter" PageTitle="Aged Workers List" PageWidth="1250"></Pdf>
                                    </ExportSettings>
                                 ...
                                 <MasterTableView DataKeyNames="WorkerID" DataSourceID="workerSource" PageSize="50" ToolTip="Double click to show details">
                                     <Columns>
                                         ...
                                         <telerik:GridDateTimeColumn DataField="Date_Birth" DataType="System.DateTime" FilterControlAltText="Filter Date_Birth column" HeaderText="Date of Birth" SortExpression="Date_Birth" UniqueName="Date_Birth" AutoPostBackOnFilter="true" ShowFilterIcon="true" FilterControlWidth="120px" DataFormatString="{0:dd-MMM-yyyy}">
                                           <HeaderStyle Width="170px" />
                                           </telerik:GridDateTimeColumn>
                                         <telerik:GridNumericColumn DataField="Age" FilterControlAltText="Filter Age column" HeaderText="Age" SortExpression="Age" UniqueName="Age" AutoPostBackOnFilter="true" ShowFilterIcon="true" FilterControlWidth="60px">
                                         ...
                                         <telerik:GridButtonColumn Visible="false" ButtonType="PushButton" CommandName="Edit" ButtonCssClass="btn-info" Text="Edit" Exportable="false">
                                        <HeaderStyle Width="50px" />
                                        </telerik:GridButtonColumn>
                        ...
                        <asp:SqlDataSource ID="workerSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [WorkerID], [SName], [OName], [Date_Birth], CONVERT(int, DATEDIFF(d, Date_Birth, @AgeDate) / 365.25) AS Age, [GangName], [SSFNo], [TradegroupNAME], [TradetypeNAME], [NHIS], [ezwichid] FROM [vwWorkers] WHERE CONVERT(int, DATEDIFF(d, Date_Birth, @AgeDate) / 365.25) >= 58 ORDER BY [Age]">
                           <SelectParameters>
                               <asp:ControlParameter Name="AgeDate" ControlID="dpFilter" PropertyName="SelectedDate" />
                           </SelectParameters>
                        </asp:SqlDataSource>
                    </ContentTemplate>
                             <Triggers>
