...
namespace GDLCApp.Reports.Monthly.Stored
{
    public partial class vwMonthlyInvoice_ByCompany : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyInvoice_Stored_ByCompany";
            ...
            {
                MonthlyInvoiceReport_ByCompany.ReportSource = Cache[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetMonthlyInvoiceByCompany_Stored", connection);
            ...
            MonthlyInvoiceReport_ByCompany.ReportSource = rpt;
        }
    }
}