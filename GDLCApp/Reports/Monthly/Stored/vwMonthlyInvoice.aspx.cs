...
{
    public partial class vwMonthlyInvoice : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyInvoice_Stored";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            rptMonthlyInvoice rpt = new rptMonthlyInvoice();
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyInvoice_Stored where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyInvoice_Stored");
            ...
            MonthlyInvoiceReport.ReportSource = rpt;
        }
    }
}