...
{
    public partial class vwMonthlyPF_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyPF_ByCompany";
            ...
            {
                MonthlyPFReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetMonthlyPFByCompany", connection);
            ...
            MonthlyPFReport_ByCompany.ReportSource = rpt;
        }
    }
}