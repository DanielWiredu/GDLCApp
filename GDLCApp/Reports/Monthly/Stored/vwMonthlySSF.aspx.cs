...
namespace GDLCApp.Reports.Monthly.Stored
{
    public partial class vwMonthlySSF : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlySSF";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlySSF where (Adate between @startdate and @enddate)", connection);
