...
{
    public partial class vwMonthlyLeaveBonus_ByCompany : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            string cachedReports = "rptMonthlyLeaveBonus_ByCompany";
            ...
            {
                MonthlyLeaveBonusReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("spGetMonthlyLeaveBonusByCompany", connection);
            ...
            MonthlyLeaveBonusReport_ByCompany.ReportSource = rpt;
        }
    }
}