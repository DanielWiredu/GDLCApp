...
namespace GDLCApp.Reports.Monthly.Stored
{
    public partial class vwMonthlyTax : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyTax";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyTax where (Adate between @startdate and @enddate)", connection);
