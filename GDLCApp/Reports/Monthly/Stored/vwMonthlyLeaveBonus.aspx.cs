...
namespace GDLCApp.Reports.Monthly.Stored
{
    public partial class vwMonthlyLeaveBonus : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyLeaveBonus";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyLeaveBonus where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyLeaveBonus");
