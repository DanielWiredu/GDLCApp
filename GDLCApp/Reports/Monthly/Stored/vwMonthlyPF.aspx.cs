...
namespace GDLCApp.Reports.Monthly.Stored
{
    public partial class vwMonthlyPF : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyPF";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyPF where (Adate between @startdate and @enddate)", connection);
