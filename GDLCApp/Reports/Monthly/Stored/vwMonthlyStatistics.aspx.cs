...
namespace GDLCApp.Reports.Monthly.Stored
{
    public partial class vwMonthlyStatistics : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyStatistics_Stored";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyStatistics_Stored where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyStatistics_Stored");
