...
{
    public partial class vwMonthlyReportListingPreview : System.Web.UI.Page
    {
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("SELECT * FROM vwMonthlyReportListingPreview WHERE (date_ between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyReportListingPreview");
