...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlyReportListing_ByCompany : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyReportListing_ByCompany";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("spGetMonthlyReportListingByCompany", connection);
            ...
            adapter.Fill(ds, "vwMonthlyReportListing");
