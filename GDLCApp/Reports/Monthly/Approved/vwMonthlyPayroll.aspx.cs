...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlyPayroll : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyPayroll";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyPayroll where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyPayroll");
