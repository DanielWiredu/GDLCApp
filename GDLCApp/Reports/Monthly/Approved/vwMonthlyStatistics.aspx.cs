...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlyStatistics : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyStatistics";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyStatistics where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyStatistics");
