...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlyPayroll_Individual : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyPayroll_Individual";
        ...
        protected void loadReportNew(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("select * from vwMonthlyApprovedCostSheet where workerid = @workerid and (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlyApprovedCostSheet");
