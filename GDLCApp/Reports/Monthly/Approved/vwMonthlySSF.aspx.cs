...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlySSF : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlySSF_Approved";
            ...
            {
                MonthlySSFReport.ReportSource = Cache[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlySSF_Approved where (Adate between @startdate and @enddate)", connection);
            ...
            adapter.Fill(ds, "vwMonthlySSF_Approved");
