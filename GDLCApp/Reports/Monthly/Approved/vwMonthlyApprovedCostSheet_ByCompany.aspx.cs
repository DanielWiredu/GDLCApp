...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlyApprovedCostSheet_ByCompany : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyApprovedCostSheet_ByCompany";
            ...
            {
                MonthlyApprovedCostSheetReport_ByCompany.ReportSource = Session[cachedReports];
            }
        }
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            edate.Value = enddate;
            adapter = new SqlDataAdapter("spGetMonthlyApprovedCostSheetByCompany", connection);
