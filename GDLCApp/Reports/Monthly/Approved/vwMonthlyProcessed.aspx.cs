...
namespace GDLCApp.Reports.Monthly.Approved
{
    public partial class vwMonthlyProcessed : System.Web.UI.Page
    {
        ...
        {
            string cachedReports = "rptMonthlyProcessed";
        ...
        protected void loadReport(string cachedReports)
        {
            ...
            adapter = new SqlDataAdapter("select * from vwMonthlyProcessed where (Adate between @startdate and @enddate)", connection);
