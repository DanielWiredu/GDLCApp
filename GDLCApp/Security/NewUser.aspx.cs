...
namespace GDLCApp.Security
{
    public partial class NewUser : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into tblUsers(username,userpassword,userroles,fullname,gender,maritalstatus,contactno,email,posttype,address,active,userkey) values(@uname,@upass,@uroles,@fname,@gender,@mstatus,@contactno,@email,@post,@address,@active,@userkey)";
