<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="GDLCApp.Security.EditUser" %>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-2">
                         ...
                         <asp:TextBox ID="txtUserkey" runat="server" Width="100%" MaxLength="2"></asp:TextBox>
