...
{
    public partial class EditPayrollSetup : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            query += "TaxOnTransport=@TaxOnTransport, OnBoardAllowance=@OnBoardAllowance, Vat=@Vat, GetFund=@GetFund, NHIL=@NHIL, UpdateStatus=@UpdateStatus,UpdatedBy=@UpdatedBy,UpdatedDate=@UpdatedDate where Id=@Id";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    //command.Parameters.AddWithValue("@EndDate", dpEndDate.SelectedDate ?? (object)DBNull.Value);
