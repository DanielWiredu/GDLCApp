<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="TradeType.aspx.cs" Inherits="GDLCApp.Tools.TradeType" %>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">New Trade Type</h4>
                </div>
                        <div class="modal-body">
                             <div class="form-group">
                                        <label> Name</label>
                                       <asp:TextBox runat="server" ID="txtTradeType" Width="100%" MaxLength="50"></asp:TextBox>
                                   <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ControlToValidate="txtTradeType" Display="Dynamic" ForeColor="Red" SetFocusOnError="true" ValidationGroup="new"></asp:RequiredFieldValidator>
                             </div>
                            <div class="form-group">
                                <label>Trade Group</label>
                                <telerik:RadComboBox ID="dlTradeGroup" runat="server" Width="100%" DataSourceID="tradeGroupSource" DataTextField="TradegroupNAME" DataValueField="TradegroupID" Filter="Contains" MarkFirstMatch="true" ></telerik:RadComboBox>
                            ...
                            <div class="form-group">
                                <label>Prefix</label>
                                <asp:TextBox runat="server" ID="txtPrefix" Width="100%" MaxLength="5"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Notes</label>
    ...
    <div class="modal-dialog" style="width:50%">
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title">Edit Trade Type</h4>
                </div>
                        <div class="modal-body">
                             <div class="form-group">
                                        <label> Name</label>
                                       <asp:TextBox runat="server" ID="txtTradeType1" Width="100%" MaxLength="50"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <label>Trade Group</label>
                                <telerik:RadComboBox ID="dlTradeGroup1" runat="server" Width="100%" DataSourceID="tradeGroupSource" DataTextField="TradegroupNAME" DataValueField="TradegroupID" Filter="Contains" MarkFirstMatch="true" ></telerik:RadComboBox>
                            </div>
                            <div class="form-group">
                                <label>Prefix</label>
                                <asp:TextBox runat="server" ID="txtPrefix1" Width="100%" MaxLength="5" ></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Notes</label>
